...
namespace PagingWPFDataGrid
{
	...
	class Paging
	{
        ...
        public DataTable Next(IList<ProductModel.Product> ListToPage, int RecordsPerPage)
        {
            PageIndex++;
        ...
        /// <param name="RecordsPerPage"></param>
        /// <returns>DataTable</returns>
        public DataTable Previous(IList<ProductModel.Product> ListToPage, int RecordsPerPage)
        {
            PageIndex--;
            if(PageIndex <= 0)
            {
        ...
        /// <param name="RecordsPerPage"></param>
        /// <returns>DataTable</returns>
        public DataTable First(IList<ProductModel.Product> ListToPage, int RecordsPerPage)
        {
            PageIndex = 0;
            PagedList = SetPaging(ListToPage, RecordsPerPage);
            return PagedList;
        ...
        /// <param name="RecordsPerPage"></param>
        /// <returns>DataTable</returns>
        public DataTable Last(IList<ProductModel.Product> ListToPage, int RecordsPerPage)
        {
            PageIndex = ListToPage.Count / RecordsPerPage;
            PagedList = SetPaging(ListToPage, RecordsPerPage);
            return PagedList;
        ...
        /// <param name="RecordsPerPage"></param>
        /// <returns>DataTable</returns>
		public DataTable SetPaging(IList<ProductModel.Product> ListToPage, int RecordsPerPage)
		{
			int PageGroup = PageIndex * RecordsPerPage;

			IList<ProductModel.Product> PagedList = new List<ProductModel.Product>();
